...
/**
 * Resolves this promise to a rejected state if `err` is passed or fulfilled state if no `err` is passed.
 *
 ...
 *
 * It will be executed with traditional node.js argument position `function (err, args...) {}`.
 *
 * Also aliased as `#addBack` for backwards compatibility.
 *
 * @method onResolve
 * @param {Function} fn
 * @return {Promise} this
 ...
 *
 * Also aliased as `#complete` for backwards compatibility.
 *
 * @method fulfill
 * @api public
 */
 ...
 *
 * Also aliased as `#addCallback` for backwards compatibility.
 *
 * @method onFulfill
 * @return {Promise} this
 * @api public
 ...
 *
 * Also aliased as `#addErrback` for backwards compatibility.
 *
 * @method onReject
 * @return {Promise} this
 * @api public
